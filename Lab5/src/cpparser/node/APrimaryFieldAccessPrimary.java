...
public final class APrimaryFieldAccessPrimary extends PPrimary
{
    private PFieldAccess _fieldAccess_;

    public APrimaryFieldAccessPrimary()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrimaryFieldAccessPrimary(
    ...
    {
        ((Analysis) sw).caseAPrimaryFieldAccessPrimary(this);
    }
