...
import cpparser.node.AStringType;
...
//				System.out.println("Successful command " + node.getIdent().getLine() + ": " + node);
...
//				// the current scope!
//				System.out.println("Unsuccessful command " + node.getIdent().getLine() + ": " + node
//						+ " -- redeclaration of identifier " + id);
//			} else {
//				System.out.println("Unsuccessful command " + node.getIdent().getLine() + ": " + node
//						+ " -- class declarations are not " + "allowed in this scope");
//			}
//		}
//	}
//
...
//				// To be completely accurate, we would have look only in
//				// the current scope!
//				System.out.println("Unsuccessful command " + phdr.getIdent().getLine() + ": " + node
//						+ " -- redeclaration of identifier " + id);
//			} else {
//				System.out.println("Unsuccessful command " + phdr.getIdent().getLine() + ": " + node
//						+ " -- method declarations are not " + "allowed in this scope");
//			}
//		} else {
//			System.out.println("Successful command " + phdr.getIdent().getLine() + ": " + node + ";");
//		}
//		symtab.leaveScope();
//	}
//
//	public void outAMethodHdr(AM node) {
//		String id = node.getIdent().getText();
...
//					System.out.println(
//							"Unsuccessful command " + node.getIdent().getLine() + ": " + node + " -- invalid type");
//				} else {
//					String id = node.getIdent().getText();
...
//				System.out.println(
//						"Unsuccessful command " + node.getIdent().getLine() + ": " + node + " -- invalid command");
//			}
//		}
//	}
//
...
////			} else {
////				System.out.println(
////						"Unsuccessful command " + node.getIdent().getLine() + ": " + node + " -- unknown identifier");
////			}
////		}
////	}
////
...
////				if (e != null) {
////					System.out.println("Successful command " + node.getLookup2().getLine() + ": " + node);
////					System.out.println(e);
////				} else if (symtab.lookup(id1) == null) {
////					System.out.println("Unsuccessful command " + node.getId1().getLine() + ": " + node
...
//			} else {
//				System.out.println(
//						"Unsuccessful command " + node.getIdent().getLine() + ": " + node + " -- not a ScopeEntry: ");
//			}
//		}
//	}
//
...
//			System.out.println("Successful command " + node.getEndScope().getLine() + ": " + node);
//			System.out.println("Leaving scope ");
//			System.out.println(previous);
//			System.out.println("The new scope is ");
//			System.out.println(symtab.currentScope());
//		} else {
//			System.out.println("Unsuccessful command " + node.getEndScope().getLine() + ": " + node
...
//		if (me != null) {
//			System.out.println("Successful command " + node.getEnclosingMethod().getLine() + ": " + node);
//			System.out.println(me);
//		} else {
//			System.out.println("Unsuccessful command " + node.getEnclosingMethod().getLine() + ": " + node);
//		}
//	}
//
//	public void outANewBlockCommand(ANewBlockCommand node) {
//		if (symtab.enterNewBlock()) {
//			System.out.println("Successful command " + node.getNewBlock().getLine() + ": " + node);
//		} else {
//			// should always be successful, but just in case
//			System.out.println("Unsuccessful command " + node.getNewBlock().getLine() + ": " + node);
//		}
//	}
//
//	public void outAPrintSymtabCommand(APrintSymtabCommand node) {
//		System.out.println("Successful command " + node.getPrintSymtab().getLine() + ": print_symtab ");
...
//				if (!symtab.insertBinding(ve)) {
//					System.out.println(
//							"Redeclaration of formal parameter at line " + node.getIdent().getLine() + ": " + node);
//				}
//			} else {
