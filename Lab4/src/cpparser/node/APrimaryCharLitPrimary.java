...
public final class APrimaryCharLitPrimary extends PPrimary
{
    private TCharacterLiteral _characterLiteral_;

    public APrimaryCharLitPrimary()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrimaryCharLitPrimary(
    ...
    {
        ((Analysis) sw).caseAPrimaryCharLitPrimary(this);
    }
