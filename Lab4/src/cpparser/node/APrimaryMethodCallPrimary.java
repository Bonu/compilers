...
public final class APrimaryMethodCallPrimary extends PPrimary
{
    private PMethodCall _methodCall_;

    public APrimaryMethodCallPrimary()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrimaryMethodCallPrimary(
    ...
    {
        ((Analysis) sw).caseAPrimaryMethodCallPrimary(this);
    }
