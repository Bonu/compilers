...
public final class AVoidIdentifierMethodHdr extends PMethodHdr
{
    private TVoid _void_;
    private TIdentifier _identifier_;

    public AVoidIdentifierMethodHdr()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVoidIdentifierMethodHdr(
    ...
    {
        ((Analysis) sw).caseAVoidIdentifierMethodHdr(this);
    }
