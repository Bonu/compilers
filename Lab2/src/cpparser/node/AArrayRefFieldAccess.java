...
public final class AArrayRefFieldAccess extends PFieldAccess
{
    private PArrayRef _arrayRef_;

    public AArrayRefFieldAccess()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArrayRefFieldAccess(
    ...
    {
        ((Analysis) sw).caseAArrayRefFieldAccess(this);
    }
