...
public final class APrimaryIntLitPrimary extends PPrimary
{
    private TIntegerLiteral _integerLiteral_;

    public APrimaryIntLitPrimary()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrimaryIntLitPrimary(
    ...
    {
        ((Analysis) sw).caseAPrimaryIntLitPrimary(this);
    }
