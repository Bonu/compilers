...
public final class AClassHdrLeftClassDecl extends PClassDecl
{
    ...
    public Object clone()
    {
        return new AClassHdrLeftClassDecl(
    ...
    {
        ((Analysis) sw).caseAClassHdrLeftClassDecl(this);
    }
