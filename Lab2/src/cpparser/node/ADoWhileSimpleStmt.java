...
public final class ADoWhileSimpleStmt extends PSimpleStmt
{
    private TDo _do_;
    ...
    {
        ((Analysis) sw).caseADoWhileSimpleStmt(this);
    }
